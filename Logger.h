...
namespace CPlusPlusLogging
{
   ...
   #define LOG_ERROR(x, ...)    Logger::getInstance()->error(x, ##__VA_ARGS__)
   #define LOG_ALARM(x, ...)	Logger::getInstance()->alarm(x, ##__VA_ARGS__)
   #define LOG_ALWAYS(x, ...)   Logger::getInstance()->always(x, ##__VA_ARGS__)
   #define LOG_INFO(x, ...)     Logger::getInstance()->info(x, ##__VA_ARGS__)
   #define LOG_BUFFER(x, ...)   Logger::getInstance()->buffer(x, ##__VA_ARGS__)
   #define LOG_TRACE(x, ...)    Logger::getInstance()->trace(x, ##__VA_ARGS__)
   #define LOG_DEBUG(x, ...)    Logger::getInstance()->debug(x, ##__VA_ARGS__)
